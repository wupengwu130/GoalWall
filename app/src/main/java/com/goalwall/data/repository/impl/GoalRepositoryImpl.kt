...
class GoalRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateProgress(goalId: Long, progress: Float) = TODO("Not yet implemented")

    override suspend fun addMilestone(goalId: Long, title: String) = TODO("Not yet implemented")

    override suspend fun toggleMilestone(milestoneId: Long, done: Boolean) = TODO("Not yet implemented")
}
